...
* How to work on the particle effects and implementing it
...
* Created particle effects and tuned in the values in it and also implemented in code
...
* The particlesystem is noting adding in the inspector dont know what is the issue
